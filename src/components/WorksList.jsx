...
const WorksList = async () => {
  ...
  return (
    <div>
      <div className=" max-w-full px-[40px] pt-[67px] pb-16 bg-white justify-center items-center">
        <div className="self-stretch flex-col justify-start items-start">
          <div className="flex-col pl-5 justify-start items-start flex">
          ...
          <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:gap-10 gap-0 text-center md:text-left">
            <div className="w-[380px] px-[30px] py-[50px] bg-white rounded-[30px] flex-col justify-start items-start gap-[43px] inline-flex">
