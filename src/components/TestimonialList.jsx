  ...
  return (
    <section>
      <div className="max-w-full py-20 bg-gray-50 radius-for-skewed overflow-hidden">
        <div className="lg:left-[105px] left-[50px] absolute flex-col justify-start items-start gap-10 inline-flex">
          <div className="flex-col justify-start items-start gap-[15px] flex">
            <div className="text-green-500 text-base lg:text-xl font-medium uppercase">
              Testimonial List
            </div>
            <div className="w-[495px] text-black text-xl lg:text-3xl font-semibold">
